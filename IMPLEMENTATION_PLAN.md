...
- [x] Agent 파일 symlink (4개)
  ```
  .claude/agents/
  ├── architect.md -> /path/to/claude-code-config/agents/architect.md
  ├── code-reviewer.md -> /path/to/claude-code-config/agents/code-reviewer.md
  ├── security-reviewer.md -> /path/to/claude-code-config/agents/security-reviewer.md
  └── tdd-guide.md -> /path/to/claude-code-config/agents/tdd-guide.md
  ```
- [x] Skill 디렉토리 symlink (4개)
  ```
  .claude/skills/
  ├── backend-patterns -> /path/to/claude-code-config/skills/backend-patterns
  ├── postgres-patterns -> /path/to/claude-code-config/skills/postgres-patterns
  ├── security-review -> /path/to/claude-code-config/skills/security-review
  └── tdd-workflow -> /path/to/claude-code-config/skills/tdd-workflow
  ```
