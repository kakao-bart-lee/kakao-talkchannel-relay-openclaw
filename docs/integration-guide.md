# Kakao Relay Server 연동 가이드

## 개요

이 문서는 Kakao Talk Channel을 OpenClaw 인스턴스와 연동하기 위한 릴레이 서버의 연동 절차를 설명합니다.
...
**핵심 개념:**
- 하나의 카카오 톡채널(봇)을 여러 OpenClaw 인스턴스가 공유
...
**Admin UI 사용:**
```
URL: https://kakao-talkchannel-relay-525484043977.asia-northeast3.run.app/admin/
...
2. 웹훅 URL 등록:
   ```
   https://kakao-talkchannel-relay-525484043977.asia-northeast3.run.app/kakao/webhook
   ```
...
```env
KAKAO_RELAY_URL=https://kakao-talkchannel-relay-525484043977.asia-northeast3.run.app
...
- **릴레이 서버**: https://kakao-talkchannel-relay-525484043977.asia-northeast3.run.app
- **Admin UI**: https://kakao-talkchannel-relay-525484043977.asia-northeast3.run.app/admin/
- **Health Check**: https://kakao-talkchannel-relay-525484043977.asia-northeast3.run.app/health
